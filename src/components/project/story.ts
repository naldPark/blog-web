export default {
    ...
    Nas: {
        title: "저장장치",
        content: "주 역할은 k8s에서의 storageClass로 Nas내에 Persistent Volume을 만들어서 사용중\n\n 그 외에 Nexus 레파지토리로도 사용"
    },
    Github: {
        title: "형상관리툴",
        content: "CI / CD 로 깃헙과 연결하여 배포 자동화처리가 되어있음\n\n이후에 github Actions도 해보자"
    },
    Helm: {
        title: "Kubernetes 배포시 사용",
        content: "여러가지 어플리케이션을 간단한 cmd명령어로 실행할 수 있는데, nfs는 Helm을 활용하여 설치함"
    },
}

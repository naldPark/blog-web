<template>
  ...
  >
    ...
    <v-btn
      ...
      @click="updateShowLoginDialog(true)"
      color="primary"
      variant="outlined"
      rounded
      class="ma-2"
    ...
    <v-list dense :class="{ beforeLoginNav: !accountInfo }">
      <div class="text-center mt-3">
        <v-avatar
          ...
          color="secondary"
          size="80"
          v-if="accountInfo && accountInfo.accountName"
        >
  ...
  <LoginDialog
    v-model:modelValue="showLoginDialog"
    msg="Vue 3 + TypeScript + Vite + Vuetify 3"
  />
  <ChangePasswordDialog
    v-model="showEditAccountInfoDialog"
    v-if="accountInfo?.accountId"

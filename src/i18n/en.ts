export default {
  ...
  editUserPassword: 'Changing the password for {0}.',
  ...
  passwordRulesError:
    'Use 8-16 characters, including letters, numbers, and symbols',
  passwordMatchRulesError: 'Passwords do not match.',
  ...
  deleteRowMsg: 'Are you sure to delete {0} ?',
  ...
  video: {
    ...
    upload: 'upload',
    coverSizeWarning: 'Cover size should be less than 2 MB',
  ...
  sandbox: {
    ...
    rules: 'Rules',
    rulesDesc:
      "- one sandbox is provided based ubuntu per id <br>  - change status to stop if you don't use it<br>  - sandbox will be initialized if no access more than 10 days <br> ",
    rulesDesc1:
      '- 각 id당 하나의 linux 기반의 샌드박스만 제공 /n  - 사용하지 않는 경우 샌드박스는 stop상태로 변경/n   - 10일간 미사용시 샌드박스는 초기화 됨 /n ',
    howToUse: 'How to use',
    howToUseDesc:
      '- It is able to access when status is running <br>- Click the button startInstatnce / Password is written on right side of the button <br>',

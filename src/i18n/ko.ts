export default {
  ...
  sandbox: {
    funcInfo: "기능 정보",
    rules: "규칙",
    rulesDesc: "- 각 id당 하나의 linux 기반의 샌드박스만 제공 <br>  - 사용하지 않는 경우 샌드박스는 stop상태로 변경<br>  - 10일간 미사용시 샌드박스는 초기화 됨 <br> ",
    howToUse: "사용방법",
    howToUseDesc: "- 상태가 Running이 아닌 경우 Running으로 변경 후 접속 가능 <br>- 하단의 인스턴스 시작 버튼 클릭 / 비밀번호는 버튼 우측에서 확인 가능 <br>",

...
export default {
  ...
  editUserPassword: '{0}의 비밀번호를 변경합니다.',
  adminPage: '관리자 페이지',
  logout: '로그아웃',
  id: '아이디',
  ...
  nameValidate: '영문/숫자/한글 포함 2-10 자리로 입력하세요',
  ...
  video: {
    ...
    upload: '업로드',
    coverSizeWarning: '이미지 사이즈는 2MB 이하만 가능합니다',
  ...
  error_code: {
    ...
    error_not_found_003: '존재하지 않는 유저 입니다.',
    error_forbidden_002: '권한이 없는 계정입니다',
  },
  noticeNewPage:

  ...
  <div class="sandbox-wrapper">
    ...
    <VCard variant="outlined" elevation="0" class="sandbox-card">
      ...
      <VCardText>
        ...
        <VSelect style="max-width: 300px" item-text="name" class="input-custom pt-0" v-model="selectedStatusItem"
    ...
    <VCard variant="outlined" elevation="0" class="sandbox-card">
      ...
      <VCardText>
        <VTreeview v-model="selectedTree" class="source-folder" :opened="initiallyOpen" item-key="name"

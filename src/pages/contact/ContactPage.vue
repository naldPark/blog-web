      ...
      <div class="text-md-left pa-7 contact-box">
        ...
        <v-theme-provider dark>
          <v-row class="pa-2">
            ...
            <v-col cols="12">
              <v-textarea :class="{ contentArea: !mobile }" v-model="messageData.content" :rules="[rules.required]"
                auto-grow flat solo :label="`${$t('content')} *`" :placeholder="`${$t('content')} *`"></v-textarea>
            </v-col>

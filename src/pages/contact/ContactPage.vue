      ...
      <VCol cols="10" md="6">
        <div class="text-md-left pa-7 contact-box">
          ...
          <VThemeProvider>
            <VRow class="pa-2">
              <VCol cols="12">
                <VTextField flat v-model="messageData.name" :rules="[rules.required]" :label="`${$t('name')} *`"
                  :placeholder="`${$t('name')} *`"></VTextField>
              </VCol>
              <VCol cols="12">
                <VTextField flat v-model="messageData.email" :rules="[rules.required, rules.email]"
                  :label="`${$t('email')} *`" :placeholder="`${$t('email')} *`"></VTextField>
              </VCol>
              <VCol cols="12">
                <VTextField v-model="messageData.title" :rules="[rules.required]" :label="`${$t('title')} *`"
                  :placeholder="`${$t('title')} *`"></VTextField>
              </VCol>
              <VCol cols="12">
                <VTextarea v-model="messageData.content" :rules="[rules.required]" auto-grow flat solo
                  :label="`${$t('content')} *`" :placeholder="`${$t('content')} *`"></VTextarea>
              </VCol>
              <VCol class="mx-auto" cols="auto">
                <VBtn color="primary" rounded variant="outlined" @click="sendMessage">

      ...
      <v-row>
        <v-col cols="12" sm="6">
          ...
          <v-timeline>
            ...
            <v-timeline-item color="grey darken-3" class="text-left" small>
          ...
          <v-card color="rgba(0, 0, 0, 0)" class="mx-auto" tile elevation="0">
            ...
            <v-list-item>
              <v-list-item-content>
                ...
                <v-list-item-subtitle class="pa-2">
                  <p class="font-weight-bold text-subtitle-1">
                    <v-icon>mdi-kubernetes</v-icon> Kubernetes
                  </p>
                  <v-progress-linear
                    rounded
                    height="10"

    ...
    <div class="main-cover">
      <VRow class="pt-5 align-center">
        <div class="main-content" :class="{ 'is-mobile': isMobile }">
          ...
          <span class="main-title-sub">인테리어 확장공사중 (소음심한날: 빨간날, 칼퇴한날)</span>
          <p class="typing text-right">
            . . of<span class="txt-type ml-1" data-wait="3000"
              data-words='["Odds and end.", "Programming.", "Operation."]'></span>
          </p>
          <VRow class="badges-image-wrapper mt-3" style="max-width: 600px">
            <VChip v-for="(item, index) in badges" :key="index" size="small" class="ma-1" :color="item.backgroundColor"
